...
export function useStream() {
    ...
    const streamMessage = useCallback(async (conversationId: number, data: { content: string, mode: "fix"|"edit"|"generate"|"convert"|"translate"|"explain"|"document"|"test", code?: string, language?: string, image?: string, imageMediaType?: string, sourceUrl?: string }) => {
        setIsStreaming(true);
        setStreamedContent("");
        setStreamError(null);
