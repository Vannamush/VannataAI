...
export const getListExamplesUrl = () => {
  ...
  return `/api/anthropic/examples`
}

/**
 * @summary List preloaded example requests
 */
export const listExamples = async ( options?: RequestInit): Promise<Example[]> => {

  return customFetch<Example[]>(getListExamplesUrl(),
  {
    ...options,
    method: 'GET'
...
export const getListExamplesQueryKey = () => {
    return [
    `/api/anthropic/examples`
    ] as const;
    }


export const getListExamplesQueryOptions = <TData = Awaited<ReturnType<typeof listExamples>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listExamples>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListExamplesQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof listExamples>>> = ({ signal }) => listExamples({ signal, ...requestOptions });
...
export function useListExamples<TData = Awaited<ReturnType<typeof listExamples>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof listExamples>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
